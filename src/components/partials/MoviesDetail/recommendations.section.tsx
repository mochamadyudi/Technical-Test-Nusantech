...
const RecommendationsSection: React.FC = () => {
  const state = useSelector<any, ITmdbState['movies']['show']['recommendations']>((state: any) => {
  ...
  return (
    <React.Fragment>
      <TheContainer className="py-10 space-y-20">
        <Typography.Title level={2} className="!text-4xl">Recommendations</Typography.Title>
